...
| 92 | 2025-01 | 2025 | CeraVe 適樂膚 (L'Oréal) | 馬來貘 LAIMO | INDEPENDENT | Taiwan illustrator IP by Cherng (本名 楊承霖; corrected from 陳信宇 per ip-timelines/laimo-cherng.md), creator-owned; licensing agency-run by 華研國際音樂 HIM 2015-2023, in-house 承三工作室 from 2024 | yes | Skincare (保濕限定組 + 周邊; 多通路) | https://www.marieclaire.com.tw/beauty/news/84300 | REP=yes (open only post-2023; agency-repped 2015-2023 - see ip-timelines/laimo-cherng.md); individual illustrator, historically very open ad-hoc collabs; big-brand x TW indie |
