# Japan co-branding census - portfolio vs independent IP

RECURRING TASK. Region-by-region series (Taiwan done: 129 rows). This is
the JAPAN run - identical definition and rules to Taiwan so the three
...
in JAPAN from 2024-01-01 to present (full-year 2024, full-year 2025, and
...
Japan-market campaigns only (Japanese brands or Japan editions of chains).
...
exists in Japan, not just how much indie IP exists.
...
before classifying: "[character] 権利者 / 著作権 / 管理会社", the
licensor's company page, the IP's official site. An AGENCY / 管理会社 name
in the deal is NOT the owner - dig past it to who OWNS the IP. If
...
Sweep ja sources: brand news and lifestyle press (PR TIMES, Fashion
Press, entabe, cinra, netlab/nlab), convenience-store and cafe collab
trackers (7-11/FamilyMart/Lawson campaign pages), brand official X/
Instagram announcements, character-goods and pop-up coverage, licensing
trade press. Every row curl-verified; phantom entries are the known
failure class. On a refresh run, check the existing table first and only
append campaigns not already logged.

Log to findings/census/japan/campaigns.md as one growing table: date,
...
## ANALYSIS OUTPUT findings/census/japan/_VERDICT.md (opens "As of
...
3. Indie prominence: which indie IPs appear, how often, formats, brand
   ...
   big-brand collabs?
4. The thesis read: does Japan support / refine / weaken "indies are a
...
COMPLETION: findings/census/japan/campaigns.md holds at least 120
...
findings/census/japan/_VERDICT.md exists with all five sections including
